...
<ul class="nav  second-nav-ul">
          ...
          <li><a href="allProductsManage?main-nav-li=2&second-nav-li=6">商品详细</a></li>
        </ul>
</div>
<div class="col-lg-10">

      <div class="list-group-item">
      <form enctype="multipart/form-data" method='post'  action='changeProduct'>
           <input type="text" name="food_id" value="${food.id}" style="display:none"/>
        	<div class="row">
		        <div class="col-lg-2">食物名字</div>
 				<div class="col-lg-2"><input type="text" name="food_name" value="${food.food_name}"/></div>
           </div> 
   		   <div class="row">
		        <div class="col-lg-2">食物详细</div>
 				<div class="col-lg-2"><input type="text" name="food_detail" value="${food.food_detail}"/></div>
           </div>
           <div class="row">
		        <div class="col-lg-2">学校</div>
 				<div class="col-lg-2"><input type="text" name="school" value="${food.school}"/></div>
           </div> 
           <div class="row">
		        <div class="col-lg-2">价格</div>
 				<div class="col-lg-2"><input type="text" name="price" value="${food.price}"/></div>
           </div> 
           <div class="row">
		        <div class="col-lg-2">商店名</div>
 				<div class="col-lg-2"><input type="text" name="shop_name" value="${food.shop_name}"/></div>
           </div> 
           <div>
           <input type="file" name="file" size="50" />
			<input class="change-food-btn" type="submit" value="修改" />
           </div>
      </form>
      </div>
